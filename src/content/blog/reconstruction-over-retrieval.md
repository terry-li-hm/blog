...
The conversation went like this: my two-year-old won't go to school. I [mined an LLM](/posts/the-knowledge-mining-gap) for developmental psychology frameworks. That led to asking [what humans are still good at](/posts/what-the-weights-dont-know) when AI can retrieve any framework instantly. That led to asking [whether any human advantage is permanent](/posts/no-stable-moat). And somewhere in that thread, I needed to articulate what AI governance actually means for a bank — not the textbook version, but the version that would help a real client make real decisions.
