...
description: "AI agent results should be push not pull. The queue should live where your thoughts live. The feedback loop should close on mobile. Three principles that most tools violate simultaneously."
