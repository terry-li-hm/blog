---
title: You Can't A/B Test Your Life
author: Terry Li
description: My career looks like a plan in retrospect. It wasn't. It was a series of pushes, wrong calls, and adjustments.
tags: [career, ai, life, honesty]
...
The dirty secret of ML in enterprise is that genuinely high-ROI use cases are a short list. Fraud detection, AML, credit scoring, recommendation engines, pricing — after that it gets thin. A lot of "ML projects" are dashboards with a model somewhere that nobody trusts enough to act on. At DBS, the AML work was real. But plenty of other ML initiatives across the bank were solutions looking for problems. At the bank where I built a DS function, I shipped two things that genuinely changed how people worked — and spent plenty of time on vendor evaluations and platform strategies that were harder to connect to outcomes than I'd hoped.
