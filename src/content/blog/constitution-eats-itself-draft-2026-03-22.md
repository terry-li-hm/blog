...
description: "How a ruleset for LLMs metabolises its own failure modes — converting constraints into programs, leaving only irreducible judgment behind."
tags: [vivesca, metabolism, agents]
status: draft
---
